...
//        * generation qualifier (e.g., "Jr.", "3rd", or "IV").
    ...
    public struct AlgorithmIdentifier
    {
        ...
        init?(asn1sequence : ASN1Sequence)
        {
            ...
            case .ecdsaWithSHA512:
                self.algorithm = .ecdsa(hash: .sha512)
    ...
    public struct Certificate
    {
        ...
        public init?(PEMFile file: String)
        {
        ...
        public init?(PEMString pemString: String)
        {
            for (section, object) in ASN1Parser.sectionsFromPEMString(pemString) {
                switch section
                {
                case "CERTIFICATE":
                    guard let sequence = object as? ASN1Sequence else {

...
//    }
    ...
    public subscript (_ range: Range<Int>) -> BigIntStorage {
        ...
        set {
            // debug
            // add setters to complete implementations of MutableCollection
            // see also: https://developer.apple.com/forums/thread/703340
            // and issue: https://github.com/apple/swift-nio/pull/1925
            // todo: actually complete the setter implementation (is it used?)
            print("DEBUG - DEBUG - DEBUG - DEBUG")
            preconditionFailure("BigIntStorage subscript(range:) setter not implemented!")
        }
    }
